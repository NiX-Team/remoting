 ...
 */
package com.nix.remoting.remoting.protocol;
...
import com.nix.remoting.remoting.annotation.CFNotNull;
import com.nix.remoting.remoting.exception.RemotingCommandException;
import com.nix.remoting.remoting.CommandCustomHeader;
...
public class RemotingCommand {
     ...
     * key-processor
     * code 作为key
     * key-processor 由用户自己注册{@link com.nix.remoting.remoting.RemotingService#registerProcessor(int, NettyRequestProcessor, ExecutorService)}
     * */
    private int code;
    /**
     * 消息版本
    ...
    public ByteBuffer encodeHeader(final int bodyLength) {
         ...
         * 由于{@link com.nix.remoting.remoting.netty.NettyDecoder} 继承{@link io.netty.handler.codec.LengthFieldBasedFrameDecoder}
